...
⚪ Trata-se de um aplicativo em que você insere o valor do preço do álcool e o da gasolina e ele te retorna em qual opção seria melhor abastecer. Obs.: é levado em consideração a famosa fórmula de dividir o preço do etanol pelo da gasolina. Se o resultado dessa divisão for maior que 0,7, é mais vantajoso abastecer com gasolina. Caso contrário, compensa comprar álcool.
